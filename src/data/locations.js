...
const createLocation = ({
  ...
  heroImage: `/images/locations/${slug}-hero.webp`,
  heroAlt: `${city} skyline representing the local shipping container market`,
  heroPosition,
  rating: 4.9,
  featured,
  imageReady,
...
export const locations = [
  ...
  createLocation({ slug: 'chicago-il', city: 'Chicago', displayName: 'Chicago, IL', stateCode: 'IL', stateName: 'Illinois', country: 'USA', regionLabel: 'MIDWEST CONTAINER DEPOT', featured: true }),
  createLocation({ slug: 'toronto-on', city: 'Toronto', displayName: 'Toronto, ON', stateCode: 'ON', stateName: 'Ontario', country: 'Canada', regionLabel: 'GREATER TORONTO CONTAINER DEPOT', featured: true }),
  createLocation({ slug: 'dallas-tx', city: 'Dallas', displayName: 'Dallas, TX', stateCode: 'TX', stateName: 'Texas', country: 'USA', regionLabel: 'NORTH TEXAS CONTAINER DEPOT', featured: true }),
  createLocation({ slug: 'montreal-qc', city: 'Montreal', displayName: 'Montreal, QC', stateCode: 'QC', stateName: 'Quebec', country: 'Canada', regionLabel: 'QUEBEC CONTAINER DEPOT', featured: true }),
  createLocation({ slug: 'savannah-ga', city: 'Savannah', displayName: 'Savannah, GA', stateCode: 'GA', stateName: 'Georgia', country: 'USA', regionLabel: 'COASTAL GEORGIA CONTAINER DEPOT', featured: true }),
